...
const s: Record<string, React.CSSProperties> = {
  ...
  container: {
    maxWidth: 520,
    margin: "0 auto",
    padding: "0 14px calc(72px + env(safe-area-inset-bottom, 0px) + 14px)",
    display: "grid",
    gap: 13,
    background: "#f4f7f4",
  },
  ...
  primaryBtn: {
    ...
    cursor: "pointer",
    marginTop: 2,
    boxShadow: "0 7px 16px rgba(15,23,42,.10), inset 0 -1px 0 rgba(0,0,0,.08)",
  },
