      ...
      <div style={{ fontSize: 13, color: "#9a3412", lineHeight: 1.55, fontWeight: 500 }}>
        Aspetta che il tuo admin apra una giornata per inserire la formazione.
              ...
              <PlayerPicker
                ...
                label="Portiere"
                roleLetter="P"
                roleClass="rosa-role-gk"
                value={gkText}
                onChange={setGkText}
                onFocus={() => setOpenField("gk")}
                open={openField === "gk"}
                choices={gkChoices}
              ...
              <PlayerPicker
                ...
                label="Difensore"
                roleLetter="D"
                roleClass="rosa-role-def"
                value={defText}
                onChange={setDefText}
                onFocus={() => setOpenField("def")}
                open={openField === "def"}
                choices={defChoices}
                playerLabel={playerLabel}
                realTeams={realTeams}
              ...
              <PlayerPicker
                ...
                roleLetter="C"
                roleClass="rosa-role-mid"
                value={midText}
                onChange={setMidText}
                onFocus={() => setOpenField("mid")}
                open={openField === "mid"}
                choices={midChoices}
                playerLabel={playerLabel}
                realTeams={realTeams}
              ...
              <PlayerPicker
                ...
                label="Attaccante"
                roleLetter="A"
                roleClass="rosa-role-fwd"
                value={fwdText}
                onChange={setFwdText}
                onFocus={() => setOpenField("fwd")}
                open={openField === "fwd"}
                choices={fwdChoices}
                playerLabel={playerLabel}
                realTeams={realTeams}
