...
const s: Record<string, React.CSSProperties> = {
  ...
  card: { background: "white", border: "1px solid #e5e7eb", borderRadius: 15, padding: "11px 12px", boxShadow: "0 2px 8px rgba(15,23,42,.05)", display: "flex", alignItems: "center", gap: 12, textAlign: "left", fontFamily: "inherit", cursor: "pointer", width: "100%" },
  tile: { width: 42, height: 42, borderRadius: 12, display: "grid", placeItems: "center", fontWeight: 1000, fontSize: 18, flexShrink: 0 },
