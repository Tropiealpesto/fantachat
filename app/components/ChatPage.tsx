...
const s: Record<string, React.CSSProperties> = {
  wrap: { display: "flex", flexDirection: "column", height: "100%", background: "#ece8e1" },
  ...
  eventIco: { width: 30, height: 30, borderRadius: 9, background: "#dcfce7", display: "grid", placeItems: "center", flexShrink: 0 },
  ...
  bubble: { padding: "9px 12px", borderRadius: 14, fontSize: 14, fontWeight: 600, lineHeight: 1.4, display: "flex", flexDirection: "column", gap: 6, boxShadow: "0 1px 1px rgba(0,0,0,.06)" },
  mention: { fontWeight: 1000, borderRadius: 5, padding: "0 3px" },
  pchip: { display: "inline-flex", alignItems: "center", gap: 10, background: "#f7f9fb", border: "1px solid #eceff3", borderRadius: 12, padding: "7px 9px", alignSelf: "flex-start", maxWidth: "100%" },
  ...
  composer: { background: "#f0f2f5", padding: 10, display: "flex", alignItems: "center", gap: 8 },
  tool: { width: 38, height: 38, borderRadius: 12, background: "#fff", border: "1px solid #e5e7eb", color: "#64748b", fontWeight: 1000, fontSize: 15, cursor: "pointer", flexShrink: 0, display: "grid", placeItems: "center" },
