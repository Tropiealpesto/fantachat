...
// Mostra etichetta solo sui valori "notevoli" per evitare affollamento
const renderLabel = (p: any) => {
const value = Number(p.value);
if (!value) return null;
// mostra solo se |score| >= 1.5 oppure è il massimo/minimo
const abs = Math.abs(value);
if (abs < 1.5) return null;

const isPos = value > 0;
const y = isPos ? p.y - 4 : p.y + p.height + 13;
...
<ResponsiveContainer>
<BarChart data={data} margin={{ top: 18, right: 4, left: -28, bottom: 0 }} barCategoryGap="20%">
